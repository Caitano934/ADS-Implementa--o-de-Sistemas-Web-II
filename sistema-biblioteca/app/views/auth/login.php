...
<head>
    ...
    <style>
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .box{background:#fff;border-radius:10px;padding:2.5rem 2rem;width:100%;max-width:380px;box-shadow:0 8px 32px rgba(0,0,0,.25)}
        .box h1{text-align:center;color:#1A3A5C;font-size:1.4rem;margin-bottom:.3rem}
        .box p{text-align:center;color:#6b7280;font-size:.85rem;margin-bottom:1.8rem}
        ...
        .dica{margin-top:1rem;font-size:.75rem;color:#9ca3af;text-align:center;border-top:1px solid #f3f4f6;padding-top:.75rem}
    </style>
</head>
<body>
<div class="box">
    ...
    <div class="dica">
        Login padrão: <strong>admin@biblioteca.com</strong> / <strong>admin123</strong>
    </div>
</div>
</body>
</html>
